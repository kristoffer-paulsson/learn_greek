...
\begin{table}[H]
    \begin{tabular}{c|ccc}
        ...
        \tsc{Dat/Gen} & \makecell{\grc{ἐκείνοιν} \trc{ekeinoin} \\ \small of/to those two} & \makecell{\grc{ἐκείνοιν} \trc{ekeinoin} \\ \small of/to those two} & \makecell{\grc{ἐκείνοιν} \trc{ekeinoin} \\ \small of/to those two} \\
        \hline
        \emph{\tsc{Plural}} \\
