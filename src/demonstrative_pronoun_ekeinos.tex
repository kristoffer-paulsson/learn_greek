...
\begin{table}[H]
    \begin{tabular}{c|ccc}
        ...
        \hline
        \emph{\tsc{Singular}} \\
        \tsc{Nom} & \makecell{\grc{ἐκεῖνος} \trc{ekeinos} \\ \small that man} & \makecell{\grc{ἐκείνη} \trc{ekeinē} \\ \small that woman} & \makecell{\grc{ἐκεῖνο} \trc{ekeino} \\ \small that} \\
        \tsc{Gen} & \makecell{\grc{ἐκείνου} \trc{ekeinou} \\ \small that man's} & \makecell{\grc{ἐκείνης} \trc{ekeinēs} \\ \small that woman's} & \makecell{\grc{ἐκείνου} \trc{ekeinou} \\ \small of that} \\
        \tsc{Dat} & \makecell{\grc{ἐκείνῳ} \trc{ekeinōi} \\ \small to/for that man} & \makecell{\grc{ἐκείνῃ} \trc{ekeinēi} \\ \small to/for that woman} & \makecell{\grc{ἐκείνῳ} \trc{ekeinōi} \\ \small to/for that} \\
        \tsc{Acc} & \makecell{\grc{ἐκεῖνον} \trc{ekeinon} \\ \small that man} & \makecell{\grc{ἐκείνην} \trc{ekeinēn} \\ \small that woman} & \makecell{\grc{ἐκεῖνο} \trc{ekeino} \\ \small that} \\
        \hline
        \emph{\tsc{Dual}} \\
        \tsc{Nom/Acc} & \makecell{\grc{ἐκείνω} \trc{ekeinō} \\ \small those two men} & \makecell{\grc{ἐκείνω} \trc{ekeinō} \\ \small those two women} & \makecell{\grc{ἐκείνω} \trc{ekeinō} \\ \small those two} \\
        \tsc{Dat/Gen} & \makecell{\grc{ἐκείνοιν} \trc{ekeinoin} \\ \small those two men's\\ \small to/for two men} & \makecell{\grc{ἐκείνοιν} \trc{ekeinoin} \\ \small those two women's\\ \small to/for two women} & \makecell{\grc{ἐκείνοιν} \trc{ekeinoin} \\ \small of/to/for those two} \\
        \hline
        \emph{\tsc{Plural}} \\
        ...
        \tsc{Gen} & \makecell{\grc{ἐκείνων} \trc{ekeinōn} \\ \small those men's} & \makecell{\grc{ἐκείνων} \trc{ekeinōn} \\ \small those women's} & \makecell{\grc{ἐκείνων} \trc{ekeinōn} \\ \small of those} \\
        \tsc{Dat} & \makecell{\grc{ἐκείνοις} \trc{ekeinois} \\ \small to/for those men} & \makecell{\grc{ἐκείναις} \trc{ekeinais}\\ \small to/for those women} & \makecell{\grc{ἐκείνοις} \trc{ekeinois} \\ \small to/for those} \\
        \tsc{Acc} & \makecell{\grc{ἐκείνους} \trc{ekeinous} \\ \small those men} & \makecell{\grc{ἐκείνας} \trc{ekeinas} \\ \small those women} & \makecell{\grc{ἐκεῖνα} \trc{ekeina} \\ \small those} \\
    \end{tabular}
