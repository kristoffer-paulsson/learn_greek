...
\begin{table}[H]
    \begin{tabular}{c|ccc}
        ...
        \hline
        \emph{\tsc{Singular}} \\
        \tsc{Nom} & \makecell{\grc{ἐκεῖνος} \trc{ekeinos} \\ \small that} & \makecell{\grc{ἐκείνη} \trc{ekeinē} \\ \small that} & \makecell{\grc{ἐκεῖνο} \trc{ekeino} \\ \small that} \\
        \tsc{Gen} & \makecell{\grc{ἐκείνου} \trc{ekeinou} \\ \small of that} & \makecell{\grc{ἐκείνης} \trc{ekeinēs} \\ \small of that} & \makecell{\grc{ἐκείνου} \trc{ekeinou} \\ \small of that} \\
        \tsc{Dat} & \makecell{\grc{ἐκείνῳ} \trc{ekeinōi} \\ \small to/for that} & \makecell{\grc{ἐκείνῃ} \trc{ekeinēi} \\ \small to/for that} & \makecell{\grc{ἐκείνῳ} \trc{ekeinōi} \\ \small to/for that} \\
        \tsc{Acc} & \makecell{\grc{ἐκεῖνον} \trc{ekeinon} \\ \small that} & \makecell{\grc{ἐκείνην} \trc{ekeinēn} \\ \small that} & \makecell{\grc{ἐκεῖνο} \trc{ekeino} \\ \small that} \\
        \hline
        \emph{\tsc{Dual}} \\
        \tsc{Nom/Acc} & \makecell{\grc{ἐκείνω} \trc{ekeinō} \\ \small those two} & \makecell{\grc{ἐκείνω} \trc{ekeinō} \\ \small those two} & \makecell{\grc{ἐκείνω} \trc{ekeinō} \\ \small those two} \\
        \tsc{Dat/Gen} & \makecell{\grc{ἐκείνοιν} \trc{ekeinoin} \\ \small of/to/for those two} & \makecell{\grc{ἐκείνοιν} \trc{ekeinoin} \\ \small of/to/for those two} & \makecell{\grc{ἐκείνοιν} \trc{ekeinoin} \\ \small of/to/for those two} \\
        \hline
        \emph{\tsc{Plural}} \\
        \tsc{Nom} & \makecell{\grc{ἐκεῖνοι} \trc{ekeinoi} \\ \small those} & \makecell{\grc{ἐκεῖναι} \trc{ekeinai} \\ \small those} & \makecell{\grc{ἐκεῖνα} \trc{ekeina} \\ \small those} \\
        \tsc{Gen} & \makecell{\grc{ἐκείνων} \trc{ekeinōn} \\ \small of those} & \makecell{\grc{ἐκείνων} \trc{ekeinōn} \\ \small of those} & \makecell{\grc{ἐκείνων} \trc{ekeinōn} \\ \small of those} \\
        \tsc{Dat} & \makecell{\grc{ἐκείνοις} \trc{ekeinois} \\ \small to/for those} & \makecell{\grc{ἐκείναις} \trc{ekeinais}\\ \small to/for those} & \makecell{\grc{ἐκείνοις} \trc{ekeinois} \\ \small to/for those} \\
        \tsc{Acc} & \makecell{\grc{ἐκείνους} \trc{ekeinous} \\ \small those} & \makecell{\grc{ἐκείνας} \trc{ekeinas} \\ \small those} & \makecell{\grc{ἐκεῖνα} \trc{ekeina} \\ \small those} \\
    \end{tabular}
