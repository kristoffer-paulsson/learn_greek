...
\begin{table}[H]
    \begin{tabular}{c|ccc}
        ...
        \tsc{Dat} & \makecell{\grc{ἐκείνῳ} \trc{ekeinōi} \\ \small to that} & \makecell{\grc{ἐκείνῃ} \trc{ekeinēi} \\ \small to that} & \makecell{\grc{ἐκείνῳ} \trc{ekeinōi} \\ \small to that} \\
        ...
        \tsc{Dat} & \makecell{\grc{ἐκείνοις} \trc{ekeinois} \\ \small to those} & \makecell{\grc{ἐκείναις} \trc{ekeinais}\\ \small to those} & \makecell{\grc{ἐκείνοις} \trc{ekeinois} \\ \small to those} \\
