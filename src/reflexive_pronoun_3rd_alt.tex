...
\begin{document}
    ...
    Indicating that the form \grc{αὐτοῦ} and similar forms are used as reflexive pronouns also and could be
    distinguished from its intensive counterpart.
    ...
    Ayer (2018) suggests that the form \grc{σφῶν ἑαυτῶν} (sphōn heautōn) is also used in the plural in Ancient Greek.
    But do exist in middle age church Greek.
