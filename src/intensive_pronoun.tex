...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc}
            ...
            \hline
            \emph{\tsc{Dual}} \\
            \tsc{Nom/Acc} & \makecell{\grc{αὐτώ} \trc{autō} \\ \small both men themselves} & \makecell{\grc{αὐτά} \trc{auta} \\ \small both women themselves} & \makecell{\grc{αὐτώ} \trc{autō} \\ \small both things themselves} \\
            \tsc{Dat/Gen} & \makecell{\grc{αὐτοῖν} \trc{autoin} \\ \small both men's \\ \small to/for both men} & \makecell{\grc{αὐταῖν} \trc{autain} \\ \small both women's \\ \small to/for both women} & \makecell{\grc{αὐτοῖν} \trc{autoin} \\ \small of/to/for both (n.)} \\
            \hline
            \emph{\tsc{Plural}} \\
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc}
            ...
            \hline
            \emph{\tsc{Plural}} \\
            \tsc{Nom} & \makecell{\grc{αὐτοί} \trc{autoi} \\ \small they the men themselves}
                      & \makecell{\grc{αὐταί} \trc{autai} \\ \small they the women themselves}
                      & \makecell{\grc{αὐτά} \trc{auta} \\ \small they the persons themselves} \\
            \tsc{Gen} & \makecell{\grc{αὐτῶν} \trc{autōn} \\ \small of them}
                      & \makecell{\grc{αὐτῶν} \trc{autōn} \\ \small of them}
                      & \makecell{\grc{αὐτῶν} \trc{autōn} \\ \small of them} \\
            \tsc{Dat} & \makecell{\grc{αὐτοῖς} \trc{autois} \\ \small to/for them}
                      & \makecell{\grc{αὐταῖς} \trc{autais} \\ \small to/for them}
                      & \makecell{\grc{αὐτοῖς} \trc{autois} \\ \small to/for them} \\
            \tsc{Acc} & \makecell{\grc{αὐτούς} \trc{autous} \\ \small them}
                      & \makecell{\grc{αὐτάς} \trc{autas} \\ \small them}
                      & \makecell{\grc{αὐτά} \trc{auta} \\ \small them} \\
        \end{tabular}
