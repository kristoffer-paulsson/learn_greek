...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc|c}
            ...
            \emph{\tsc{Singular}} & & & & \\
            \tsc{Nom} & -- & -- & -- & -- \\
            \tsc{Gen} & \makecell{\grc{ἐμαυτοῦ} \trc{emautou}, \\ \grc{αὐτοῦ} \trc{autou} \\ \small of himself}
                    & \makecell{\grc{ἐμαυτῆς} \trc{emautēs}, \\ \grc{αὐτῆς} \trc{autēs} \\ \small of herself}
                    & \makecell{\grc{αὐτοῦ} \trc{autou}, \\ \grc{αὐτοῦ} \trc{autou} \\ \small of oneself}
                    & \makecell{( * ) \\ \small of itself} \\
            \tsc{Dat} & \makecell{\grc{ἐμαυτῷ} \trc{emautōi}, \\ \grc{αὐτῷ} \trc{autōi} \\ \small to/for himself}
                    & \makecell{\grc{ἐμαυτῇ} \trc{emautē}, \\ \grc{αὐτῇ} \trc{autēi} \\ \small to/for herself}
                    & \makecell{\grc{αὐτῷ} \trc{autōi}, \\ \grc{αὐτῷ} \trc{autōi} \\ \small to/for oneself}
                    & \makecell{( * ) \\ \small to/for itself} \\
            \tsc{Acc} & \makecell{\grc{ἐμαυτόν} \trc{emauton}, \\ \grc{αὐτόν} \trc{auton} \\ \small himself}
                    & \makecell{\grc{ἐμαυτήν} \trc{emautēn}, \\ \grc{αὐτήν} \trc{autēn} \\ \small herself}
                    & \makecell{\grc{αὐτό} \trc{auto}, \\ \grc{αὐτό} \trc{auto} \\ \small oneself}
