...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc|c}
            ...
            \emph{\tsc{Singular}} & & & & \\
            \tsc{Nom} & -- & -- & -- & -- \\
            \tsc{Gen} & \makecell{\grc{αὐτοῦ} \trc{autou}, \\ \grc{αὐτοῦ} \trc{autou} \\ \small of himself}
            ...
            \tsc{Dat} & \makecell{\grc{αὐτῷ} \trc{autōi}, \\ \grc{αὐτῷ} \trc{autōi} \\ \small to/for himself}
            ...
            \tsc{Acc} & \makecell{\grc{αὐτόν} \trc{auton}, \\ \grc{αὐτόν} \trc{auton} \\ \small himself}
