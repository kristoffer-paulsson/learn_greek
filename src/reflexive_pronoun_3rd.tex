    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc|c}
            ...
            \tsc{Gen} & \makecell{\grc{ἑαυτοῦ} \trc{heautou}, \\ \grc{αὐτοῦ} \trc{autou} \\ \small of himself}
                    & \makecell{\grc{ἐμαυτῆς} \trc{emautēs}, \\ \grc{αὐτῆς} \trc{autēs} \\ \small of herself}
                    & \makecell{\grc{σεαυτοῦ} \trc{seautou}, \\ \grc{αὐτοῦ} \trc{autou} \\ \small of oneself}
                    & \makecell{( * ) \\ \small of itself} \\
            \tsc{Dat} & \makecell{\grc{ἑαυτῷ} \trc{heautōi}, \\ \grc{αὐτῷ} \trc{autōi} \\ \small to/for himself}
                    & \makecell{\grc{ἐμαυτῇ} \trc{emautē}, \\ \grc{αὐτῇ} \trc{autēi} \\ \small to/for herself}
                    & \makecell{\grc{σεαυτῷ} \trc{seautōi}, \\ \grc{αὐτῷ} \trc{autōi} \\ \small to/for oneself}
                    & \makecell{( * ) \\ \small to/for itself} \\
            \tsc{Acc} & \makecell{\grc{ἑαυτόν} \trc{heauton}, \\ \grc{αὐτόν} \trc{auton} \\ \small himself}
                    & \makecell{\grc{ἐμαυτήν} \trc{emautēn}, \\ \grc{αὐτήν} \trc{autēn} \\ \small herself}
                    & \makecell{\grc{σεαυτόν} \trc{seauton}, \\ \grc{αὐτό} \trc{auto} \\ \small oneself}
            ...
            \emph{\tsc{Plural}} & & & & \\
            \tsc{Nom} & -- & -- & -- & -- \\
            \tsc{Gen} & \makecell{\grc{ἡμῶν αὐτῶν} \trc{hēmōn autōn}, \\ \grc{αὐτῶν} \trc{autōn} \\ \small of themselves (m.)}
                    & \makecell{\grc{ἡμῶν αὐτῶν} \trc{hēmōn autōn}, \\ \grc{αὐτῶν} \trc{autōn} \\ \small of themelves (f.)}
                    & \makecell{\grc{αὐτῶν} \trc{autōn} \\ \small of themelves (n.)}
                    & \makecell{( * ) \\ \small of these items} \\
            \tsc{Dat} & \makecell{\grc{ἡμῖν αὐτοῖς} \trc{hēmin autois}, \\ \grc{αὐτοῖς} \trc{autois} \\ \small to/for themelves (m.)}
                    & \makecell{\grc{ἡμῖν αὐταῖς} \trc{hēmin autais}, \\ \grc{αὐταῖς} \trc{autais} \\ \small to/for themelves (f.)}
                    & \makecell{\grc{αὐτοῖς} \trc{autois} \\ \small to/for themelves (n.)}
                    & \makecell{( * ) \\ \small to/for these items} \\
            \tsc{Acc} & \makecell{\grc{ἡμᾶς αὐτούς} \trc{hēmas autous}, \\ \grc{αὐτά} \trc{auta} \\ \small themelves (m.)}
                    & \makecell{\grc{ἡμᾶς αὐτάς} \trc{hēmas autas}, \\ \grc{αὐτάς} \trc{autas} \\ \small themelves (f.)}
