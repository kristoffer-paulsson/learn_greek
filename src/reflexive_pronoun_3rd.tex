...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc|c}
            ...
            \tsc{Dat} & \makecell{\grc{ἑαυτοῖς} \trc{heautois}, \\ \grc{αὐτοῖς} \trc{autois} \\ \small to/for themelves (m.)}
                    & \makecell{\grc{ἑαυταῖς} \trc{heautais}, \\ \grc{αὐταῖς} \trc{autais} \\ \small to/for themelves (f.)}
