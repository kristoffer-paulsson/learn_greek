    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc|c}
            ...
            \tsc{Gen} & \makecell{\grc{ἐμαυτοῦ} \trc{emautou}, \\ \grc{αὐτοῦ} \trc{autou} \\ \small of himself}
                    & \makecell{\grc{αὐτῆς} \trc{autēs}, \\ \grc{αὐτῆς} \trc{autēs} \\ \small of herself}
            ...
            \tsc{Dat} & \makecell{\grc{ἐμαυτῷ} \trc{emautōi}, \\ \grc{αὐτῷ} \trc{autōi} \\ \small to/for himself}
                    & \makecell{\grc{αὐτῇ} \trc{autēi}, \\ \grc{αὐτῇ} \trc{autēi} \\ \small to/for herself}
            ...
            \tsc{Acc} & \makecell{\grc{ἐμαυτόν} \trc{emauton}, \\ \grc{αὐτόν} \trc{auton} \\ \small himself}
                    & \makecell{\grc{αὐτήν} \trc{autēn}, \\ \grc{αὐτήν} \trc{autēn} \\ \small herself}
            ...
            \emph{\tsc{Plural}} & & & & \\
            \tsc{Nom} & -- & -- & -- & -- \\
            \tsc{Gen} & \makecell{\grc{ἡμῶν αὐτῶν} \trc{hēmōn autōn} \\ \small of themselves (m.)}
                    & \makecell{\grc{αὐτῶν} \trc{autōn} \\ \grc{αὐτῶν} \trc{autōn} \\ \small of themelves (f.)}
                    & \makecell{\grc{αὐτῶν} \trc{autōn} \\ \grc{αὐτῶν} \trc{autōn} \\ \small of themelves (n.)}
                    & \makecell{( * ) \\ \small of these items} \\
            \tsc{Dat} & \makecell{\grc{ἡμῖν αὐτοῖς} \trc{hēmin autois} \\ \small to/for themelves (m.)}
                    & \makecell{\grc{αὐταῖς} \trc{autais} \\ \grc{αὐταῖς} \trc{autais} \\ \small to/for themelves (f.)}
                    & \makecell{\grc{αὐτοῖς} \trc{autois} \\ \grc{αὐτοῖς} \trc{autois} \\ \small to/for themelves (n.)}
                    & \makecell{( * ) \\ \small to/for these items} \\
            \tsc{Acc} & \makecell{\grc{ἡμᾶς αὐτούς} \trc{hēmas autous} \\ \small themelves (m.)}
                    & \makecell{\grc{αὐτάς} \trc{autas} \\ \grc{αὐτάς} \trc{autas} \\ \small themelves (f.)}
                    & \makecell{\grc{αὐτά} \trc{auta} \\ \grc{αὐτά} \trc{auta} \\ \small themelves (n.)}
