    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc|c}
            ...
            \tsc{Gen} & \makecell{\grc{αὐτοῦ} \trc{autou} \\ \small of him}
                    ...
                    & \makecell{\grc{αὐτοῦ} \trc{autou} \\ \small of that one}
                    & \makecell{( * ) \\ \small of it} \\
            \tsc{Dat} & \makecell{\grc{αὐτῷ} \trc{autōi} \\ \small to/for him}
                    & \makecell{\grc{αὐτῇ} \trc{autēi} \\ \small to/for her}
                    & \makecell{\grc{αὐτῷ} \trc{autōi} \\ \small to/for that one}
                    & \makecell{( * ) \\ \small to/for it} \\
            \tsc{Acc} & \makecell{\grc{αὐτόν} \trc{auton} \\ \small him}
                    & \makecell{\grc{αὐτήν} \trc{autēn} \\ \small her}
                    & \makecell{\grc{αὐτό} \trc{auto} \\ \small that one}
                    & \makecell{( * ) \\ \small it} \\
            \hline
            \emph{\tsc{Dual}} & -- & -- & -- & -- \\
            \hline
