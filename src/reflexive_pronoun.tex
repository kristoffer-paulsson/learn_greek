   ...
   compounding the stems of the personal pronouns with the oblique cases of \grc{αὐτός}. In the plural both pronouns
    ...
    \begin{table}[H]
        \begin{tabular}{c|cccc}
            ...
            \tsc{Dat} & \makecell{\grc{ἡμῖν αὐτοῖς} \\ \trc{hēmin autōn} \\ \small to/for us men} & \makecell{\grc{ἡμῖν αὐταῖς} \\ \trc{hēmin autais} \\ \small to/for us women}
            & \makecell{\grc{ὑμῖν αὐτοῖς} \\ \trc{humin autois} \\ \small to/for yous men} & \makecell{\grc{ὑμῖν αὐταῖς} \\ \trc{humin autais} \\ \small to/for yous women}\\

            \tsc{Acc} & \makecell{\grc{ἡμᾶς αὐτούς} \\ \trc{hēmas autous} \\ \small us men} & \makecell{\grc{ἡμᾶς αὐτάς} \\ \trc{hēmas autas} \\ \small us women}
            & \makecell{\grc{ὑμᾶς αὐτούς} \\ \trc{humas autous} \\ \small yous men} & \makecell{\grc{ὑμᾶς αὐτάς} \\ \trc{humas autas} \\ \small yous women}\\
        \end{tabular}
