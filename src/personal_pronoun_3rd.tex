...
\begin{document}
    ...
    \end{itemize}
    Personal pronouns denote the speaker, addressee, or others, (I, you, they).
    The third-person forms (he, she, it) refer to entities outside the conversation,
    linking to an antecedent. They agree with it in gender, number, and case, ensuring clarity with verbs and adjectives.
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc}
            ...
            \tsc{Dat/Gen} & \makecell{\grc{αὐτοῖν} \trc{autoin} \\ \small of/to/for both (m.)} & \makecell{\grc{αὐταῖν} \trc{autain} \\ \small both (f.)} & \makecell{\grc{αὐτοῖν} \trc{autoin} \\ \small both (n.)} \\
            \hline
            \emph{\tsc{Plural}} \\
