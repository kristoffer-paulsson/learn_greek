...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc|c}
            ...
            \tsc{Dat} & \makecell{\grc{σφίσιν αὐτοῖς} \\ \trc{sphisin autois} \\ \small to/for themselves (m.)}
                    & \makecell{\grc{σφίσιν αὐταῖς} \\ \trc{sphisin autais} \\ \small to/for themselves (f.)}
                    & \makecell{--}
                    & \makecell{--} \\
            \tsc{Acc} & \makecell{\grc{σφᾶς αὐτούς} \\ \trc{sphas autous} \\ \small themselves (m.)}
    ...
    Ayer (2018) presents a hybrid form \grc{σφῶν ἑαυτῶν} (sphōn heautōn) that is attested in post-classical and
    Byzantine Greek, where the \grc{σφ-} stem of the personal pronoun is combined with the \grc{ἑαυτ-} stem of the
    intensive pronoun.
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc|c}
            ...
            \emph{\tsc{Plural}} & & & & \\
            \tsc{Nom} & -- & -- & -- & -- \\
            \tsc{Gen} & \makecell{\grc{σφῶν ἑαυτῶν} \\ \trc{sphōn heautōn} \\ \small of themselves (m.)}
                    & \makecell{\grc{σφῶν ἑαυτῶν} \\ \trc{sphōn heautōn} \\ \small of themselves (f.)}
                    & \makecell{\grc{σφῶν ἑαυτῶν} \\ \trc{sphōn heautōn} \\ \small of themselves (n.)}
                    & \makecell{\grc{σφῶν ἑαυτῶν} \\ \trc{sphōn heautōn} \\ \small of themselves (m.f.n.)} \\
            \tsc{Dat} & \makecell{\grc{σφίσιν ἑαυτοῖς} \\ \trc{sphisin heautois} \\ \small to/for themselves (m.)}
                    & \makecell{\grc{σφίσιν ἑαυταῖς} \\ \trc{sphisin heautais} \\ \small to/for themselves (f.)}
                    & \makecell{\grc{σφίσιν ἑαυτοῖς} \\ \trc{sphisin heautois} \\ \small to/for themselves (n.)}
                    & \makecell{--} \\
            \tsc{Acc} & \makecell{\grc{σφᾶς ἑαυτούς} \\ \trc{sphas heautous} \\ \small themselves (m.)}
                    & \makecell{\grc{σφᾶς ἑαυτάς} \\ \trc{sphas heautas} \\ \small themselves (f.)}
                    & \makecell{\grc{σφᾶς ἑαυτά} \\ \trc{sphas heauta} \\ \small themselves (n.)}
                    & \makecell{--} \\
        \end{tabular}
         \caption{Hybrid periphrastic forms reconstructed by AI. Inspired by Ayer (2018) who notes the existence of a
         hybrid periphrastic form.}
    \end{table}
