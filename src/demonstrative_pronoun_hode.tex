...
\begin{document}
    ...
    \begin{tabular}{c|ccc}
        ...
        \tsc{Dat/Gen} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small of/to these both (men)} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small of/to these both (women)} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small of/to these two (things)} \\
        \hline
        \emph{\tsc{Plural}} \\
