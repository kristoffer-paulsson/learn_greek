...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc}
            ...
            \tsc{Gen} & \makecell{\grc{τοῦδε} \trc{toude} \\ \small of this (man's)} & \makecell{\grc{τῆσδε} \trc{tēsde} \\ \small of this (woman's)} & \makecell{\grc{τοῦδε} \trc{toude} \\ \small of this (thing's/one's)} \\
            ...
            \hline
            \emph{\tsc{Dual}} \\
            \tsc{Nom/Acc} & \makecell{\grc{τώδε} \trc{tōde} \\ \small these both (men)} & \makecell{\grc{τώδε} \trc{tōde} \\ \small these both (women)} & \makecell{\grc{τώδε} \trc{tōde} \\ \small these two (things)} \\
            \tsc{Dat/Gen} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small to these both (men) \\ \small of these both (men's)} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small to these both (women) \\ \small of these both (women's)} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small to these two (things) \\ \small of these two (things')} \\
            \hline
            \emph{\tsc{Plural}} \\
            ...
            \tsc{Gen} & \makecell{\grc{τῶνδε} \trc{tōnde} \\ \small of these (men's)} & \makecell{\grc{τῶνδε} \trc{tōnde} \\ \small of these (women's)} & \makecell{\grc{τῶνδε} \trc{tōnde} \\ \small of these (things')} \\
