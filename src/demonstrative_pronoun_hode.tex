...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc}
            ...
            \tsc{Dat/Gen} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small of/to these two here} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small of/to these two here} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small of/to these two here} \\
            \hline
            \emph{\tsc{Plural}} \\
