...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc}
            ...
            \tsc{Gen} & \makecell{\grc{τοῦδε} \trc{toude} \\ \small of this (man's)} & \makecell{\grc{τῆσδε} \trc{tēsde} \\ \small of this (woman's)} & \makecell{\grc{τοῦδε} \trc{toude} \\ \small of this (thing/one's)} \\
            ...
            \tsc{Dat/Gen} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small to these both (men) \\ \small of these both (men's)} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small to these both (women) \\ \small of these both (women's)} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small to/of these two (things) \\ \small} \\
            \hline
            \emph{\tsc{Plural}} \\
