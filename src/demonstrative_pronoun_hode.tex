...
\begin{document}
    ...
    will follow in the next sentence.'' It relates to its referents in terms of (here) \emph{this} or \emph{these}.
    ...
    \begin{table}[H]
        ...
        \end{tabular}
        \caption{Compilation from standard Ancient Greek grammars (Smyth, 1956:94, §333; Rydberg-Cox, n.d.) with syntactic cues.}
    \end{table}
