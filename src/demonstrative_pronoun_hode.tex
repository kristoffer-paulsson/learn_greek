...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc}
            ...
            \tsc{Dat/Gen} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small to/of these both (men)} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small to/of these both (women)} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small to/of these two (things)} \\
            \hline
            \emph{\tsc{Plural}} \\
