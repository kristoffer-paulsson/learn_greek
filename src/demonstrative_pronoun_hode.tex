...
\begin{document}
    ...
    A demonstrative pronoun is basically a word that points to something specific,
    like saying ``this'' or ``that'' in English to highlight a person, thing, or idea
    without naming it directly. It helps you ``demonstrate'' or show what you're talking
    about right in the sentence.

    At the heart of the proximal category stands \grc{ὅδε}, a pronoun that vividly
    emphasizes immediacy --- whether physical, as in gesturing to an object at hand, or
    discursive, as in introducing forthcoming thoughts --- infusing speech with a sense
    of presence and urgency that draws the audience into the moment.
