...
\begin{document}
    ...
    to something which is about to be mentioned,'' also Groton (2013:77) agrees with that \grc{ὅδε}
    ...
    \begin{table}[H]
        ...
        \end{tabular}
        \caption{Compiled from standard Ancient Greek grammars (Smyth, 1956:94, §333; Rydberg-Cox, n.d.) enhanced with transliteration and syntactic cues.}
    \end{table}
