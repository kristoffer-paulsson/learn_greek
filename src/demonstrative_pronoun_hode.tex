...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc}
            ...
            \hline
            \emph{\tsc{Singular}} \\
            \tsc{Nom} & \makecell{\grc{ὅδε} \trc{hode} \\ \small this} & \makecell{\grc{ἥδε} \trc{hēde} \\ \small this} & \makecell{\grc{τόδε} \trc{tode} \\ \small this} \\
            \tsc{Gen} & \makecell{\grc{τοῦδε} \trc{toude} \\ \small of this} & \makecell{\grc{τῆσδε} \trc{tēsde} \\ \small of this} & \makecell{\grc{τοῦδε} \trc{toude} \\ \small of this} \\
            \tsc{Dat} & \makecell{\grc{τῷδε} \trc{tōide} \\ \small to/for this} & \makecell{\grc{τῇδε} \trc{tēide} \\ \small to/for this} & \makecell{\grc{τῷδε} \trc{tōide} \\ \small to/for this} \\
            \tsc{Acc} & \makecell{\grc{τόνδε} \trc{tonde} \\ \small this} & \makecell{\grc{τήνδε} \trc{tēnde} \\ \small this} & \makecell{\grc{τόδε} \trc{tode} \\ \small this} \\
            \hline
            \emph{\tsc{Dual}} \\
            \tsc{Nom/Acc} & \makecell{\grc{τώδε} \trc{tōde} \\ \small these two} & \makecell{\grc{τώδε} \trc{tōde} \\ \small these two} & \makecell{\grc{τώδε} \trc{tōde} \\ \small these two} \\
            \tsc{Dat/Gen} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small of/to these two} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small of/to these two} & \makecell{\grc{τοῖνδε} \trc{toinde} \\ \small of/to these two} \\
            \hline
            \emph{\tsc{Plural}} \\
            \tsc{Nom} & \makecell{\grc{οἵδε} \trc{hoide} \\ \small these} & \makecell{\grc{αἵδε} \trc{haide} \\ \small these} & \makecell{\grc{τάδε} \trc{tade} \\ \small these} \\
            \tsc{Gen} & \makecell{\grc{τῶνδε} \trc{tōnde} \\ \small of these} & \makecell{\grc{τῶνδε} \trc{tōnde} \\ \small of these} & \makecell{\grc{τῶνδε} \trc{tōnde} \\ \small of these} \\
            \tsc{Dat} & \makecell{\grc{τοῖσδε} \trc{toisde} \\ \small to/for these} & \makecell{\grc{ταῖσδε} \trc{taisde}\\ \small to/for these} & \makecell{\grc{τοῖσδε} \trc{toisde} \\ \small to/for these} \\
            \tsc{Acc} & \makecell{\grc{τούσδε} \trc{tousde} \\ \small these} & \makecell{\grc{τάσδε} \trc{tasde} \\ \small these} & \makecell{\grc{τάδε} \trc{tade} \\ \small these} \\
        \end{tabular}
