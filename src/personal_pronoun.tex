...
% Document
\begin{document}
    \subsection*{Koine Greek Personal Pronouns in First and Second Person}
    \begin{itemize}[label={}, leftmargin=0]
        \item Kristoffer E.D.\ Paulsson (2026), Independent Scholar.
    \end{itemize}

    Rydberg-Cox (n.d.) says ``The nominatives of the personal pronouns are seldom used, except for emphasis.'' And also
    ``The forms \grc{μοῦ}, \grc{μοί}, \grc{μέ}; \grc{σοῦ}, \grc{σοί}, \grc{σέ}; \grc{οὗ}, \grc{οἷ}, \grc{ἕ}, are enclitic.
    ...
    To differentiate between singular and plural ``you'' in English, the modern plural ``yous''
    % and ``yourselves''\linkfoot{yourselves}{https://dictionary.cambridge.org/dictionary/english/yourselves}{2025-05-13}
    has been adpoted (Cambridge Dictionary, 2024).
     ...
     \begin{table}[H]
         \begin{tabular}{c|cc}
             ...
             \tsc{Dat/Gen} & \makecell{\grc{νῷν} \trc{nōin} \\ \small of/to us both} & \makecell{\grc{σφῷν} \trc{sphōin} \\ \small of/to you both} \\
             \hline
             \emph{\tsc{Plural}} \\
