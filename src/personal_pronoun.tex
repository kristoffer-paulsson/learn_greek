    ...
    % and ``yourselves''\linkfoot{yourselves}{https://dictionary.cambridge.org/dictionary/english/yourselves}{2025-05-13}
     ...
     \begin{table}[H]
         \begin{tabular}{c|ccc}
             ...
             \tsc{Dat} & \makecell{\grc{ἐμοί} \trc{emoi}, \grc{μοι} \trc{moi} \\ \small to/for me} & \makecell{\grc{σοί} \trc{soi}, \grc{σοι} \trc{soi} \\ \small to/for you}  & \makecell{\grc{σοῦ} \trc{sou}, \grc{σου} \trc{sou} \\ \small ( -- )} \\
             \tsc{Acc} & \makecell{\grc{ἐμέ} \trc{eme}, \grc{με} \trc{me} \\ \small me} & \makecell{\grc{σέ} \trc{se}, \grc{σε} \trc{se} \\ \small you}  & \makecell{\grc{σοῦ} \trc{sou}, \grc{σου} \trc{sou} \\ \small ( -- )} \\
             \hline
             \emph{\tsc{Dual}} \\
