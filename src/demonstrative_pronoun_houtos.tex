...
\begin{document}
    ...
    which \grc{οὗτος} functions as the \textit{medial} term. It refers to its referents as \textit{this/that} or
    \textit{these/those} in the sense of \textit{by you}, and contrasts with the proximal \grc{ὅδε} and the distal \grc{ἐκεῖνος}.
