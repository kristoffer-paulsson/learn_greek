...
\begin{document}
    ...
    to something which is about to be mentioned.'' Similarly, Groton (2013:77--8) agrees that \grc{οὗτος}
    ``points out [i.] someone or something close to the speaker \emph{or} points to [ii.] what was said in
    the preceding sentence \emph{or} [iii.] labels someone or something as well-known \emph{or} [iv.] means
    `the latter'.''
