...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc|c}
            ...
            \tsc{Gen} & \makecell{\grc{οὗτινος} \trc{houtinos} \\ \small any man to whose} & \makecell{\grc{ἧστινος} \trc{hēstinos} \\ \small any woman to whose} & \makecell{\grc{οὗτινος} \trc{houtinos} \\ \small whosever } & \makecell{( * ) \\ \small of whatever} \\
            \tsc{Dat} & \makecell{\grc{ᾧτινι} \trc{hōitini} \\ \small any man whom } & \makecell{\grc{ᾗτινι} \trc{hēitini} \\ \small any woman whom} & \makecell{\grc{ᾧτινι} \trc{hōitini} \\ \small whomever} & \makecell{( * ) \\ \small to whatever} \\
