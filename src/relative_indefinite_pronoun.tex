...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{c|ccc|c}
            ...
            \tsc{Dat} & \makecell{\grc{οἷστισι(ν)} \trc{hoistisi(n)} \\ \small any men to whom} & \makecell{\grc{αἷστισι(ν)} \trc{haistisi(n)}\\ \small any women to whom} & \makecell{\grc{οἷστισι(ν)} \trc{hoistisi(n)} \\ \small those whom} & \makecell{( * ) \\ \small to any which} \\
