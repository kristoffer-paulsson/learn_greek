...
\begin{document}
    ...
    Ayer (2018) says: ``Instead of \grc{σεαυτοῦ}, etc.,\ldots~the contracted forms \grc{σαυτοῦ}\ldots, etc., are also
    used.'' Therefore, the second-person singular reflexive pronouns can be contracted by crasis to
    \grc{σαυτοῦ} (sautou), through elision of \grc{ε} in the oblique cases.
