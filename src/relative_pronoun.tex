...
\begin{document}
    ...
    \begin{table}[H]
        ...
        \end{tabular}
        \caption{Compiled from standard Ancient Greek grammars enhanced with transliteration and syntactic cues. (Smyth, 1956:96--7, \S338)}
    \end{table}

    \subsection*{Reference List}
    \begin{itemize}[label={}, leftmargin=0]
        \item Rydberg-Cox, J. (n.d.). \textit{\chapter*{LESSON LVI: Relative Pronouns. Genitive Absolute. Numerals}}. [online] A Digital Tutorial for Ancient Greek. Available at: \url{https://daedalus.umkc.edu/FirstGreekBook/JWW_FGB56.html} [Accessed 6 Feb. 2026].
